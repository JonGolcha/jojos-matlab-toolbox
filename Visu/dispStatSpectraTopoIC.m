...
ylims1  = 20*log10([min(min(squeeze(PERCENTILE_COND1(:,:,1)))) max(max(squeeze(PERCENTILE_COND1(:,:,2))))]);
ylims2  = 20*log10([min(min(squeeze(PERCENTILE_COND2(:,:,1)))) max(max(squeeze(PERCENTILE_COND2(:,:,2))))]);
