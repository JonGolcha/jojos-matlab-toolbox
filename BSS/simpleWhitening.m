Tfunction [H, Q, M, W] = simpleWhitening(COV,PERCENT_VAR)
...
H = diag(1./W.^(1/2)) * U';             % normalize eigenvectors such that they are orthonormal
Q = U * diag(W.^(1/2));                 % normalize eigenvectors such that they are orthonormal
