function [Hd b a] = designBandPassFilter_FIR(Fstop1,Fstop2,Fs)
...
BP = Fstop2-Fstop1;
Fpass1 = Fstop1+0.25*BP;             % First Passband Frequency
Fpass2 = Fstop2-0.25*BP;            	% Second Passband Frequency
