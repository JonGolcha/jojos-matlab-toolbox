function [plv] = pn_eegPLV_modif(eegData, srate, filtSpec, dataSelectArr)
% Computes the Phase Locking Value (PLV) for an EEG dataset.
%
% MODIF JCG: 
% - filter changed to zero-phase digital filtering using filtfilt.
% - added the possibility to output the phase
%
% Input parameters:
